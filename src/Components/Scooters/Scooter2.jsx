    ...
    <div className="bg-gradient-to-r from-gray-200 to-white min-h-screen flex justify-center items-center font-serif">
      <div className="flex flex-col md:flex-row items-center justify-center w-full p-5     rounded-lg ">
        ...
        <div className="mt-8 md:mt-0 md:ml-8">
          <h1 className="text-5xl font-bold">318</h1>
          ...
          <div className="w-full h-auto px-3 md:px-10 flex flex-col items-center py-5 justify-center">
              <h1 className='font-bold text-xl'>Power features</h1>
             <img className="w-full h-full" src={power} alt="Power features" />
